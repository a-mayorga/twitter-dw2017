...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div id="header-new-tweet">
                <p>Redactar un nuevo Tweet de emergencia</p>
            </div>
            <form id="new-tweet" action="emergency_tweet.php" method="post" onsubmit="return postTweet()">
                <div>
                    <textarea name="tweet" id="tweetM" maxlength="140" placeholder="¿Cuál es la emergencia?" onkeyup="validateTweet(event)"></textarea>
                </div>
                <select name="emergency_type">
                  ...
                  <option value="4">Alerta Amber</option>
                </select>
                <div>
    ...
    <script>
      ...
      window.addEventListener('load', loadEmergencyTweets, true);
    </script>
    </body>
</html>
